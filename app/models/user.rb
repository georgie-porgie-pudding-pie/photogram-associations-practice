...
class User < ApplicationRecord
  ...
  has_many(:photos, class_name: "Photo", foreign_key: "owner_id", primary_key: "id")

  has_many(:likes, class_name: "Like", foreign_key: "fan_id", primary_key: "id")

  has_many(:follow_requests, class_name: "FollowRequest", foreign_key: "sender_id", primary_key: "id")

  has_many(:follow_receipts, class_name: "FollowRequest", foreign_key: "recipient_id", primary_key: "id")
